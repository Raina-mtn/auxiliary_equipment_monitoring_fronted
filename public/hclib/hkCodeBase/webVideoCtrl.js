(function() {
    ...
    var WebVideoCtrl = function() {
            ...
            let oPromise = new Promise(function(resolve, reject) {
                ...
                var oParam = {
                    ...
                    onConnectSuccess: ()=>{
                        ...
                        // console.log('test>>>>>>>>>.', oElem[0].parentNode.parentNode.parentNode.parentNode.getBoundingClientRect())
        ...
        ;
        this.I_Resize = function(iWidth, iHeight, iLeft, iTop ) {
            return m_pluginOBJECT.JS_Resize(iWidth, iHeight, iLeft, iTop)
        }
        ;
